...
Partial Public NotInheritable Class Feuil4
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Feuil4", "Feuil4")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Feuil4 As Feuil4
    
    Friend Shared Property Feuil4() As Feuil4
        Get
            Return _Feuil4
        End Get
        Set
            If (_Feuil4 Is Nothing) Then
                _Feuil4 = value
            Else
