...
Partial Public NotInheritable Class Feuil6
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "Feuil6", "Feuil6")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _Feuil6 As Feuil6
    
    Friend Shared Property Feuil6() As Feuil6
        Get
            Return _Feuil6
        End Get
        Set
            If (_Feuil6 Is Nothing) Then
                _Feuil6 = value
            Else
